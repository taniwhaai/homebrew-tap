class Arai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/taniwhaai/arai/releases/download/v#{version}/arai-darwin-aarch64"
      sha256 "3d347084e183f12498a5cbc30ae55633f545fb89234a700147241546fd453055"
    end
    on_intel do
      url "https://github.com/taniwhaai/arai/releases/download/v#{version}/arai-darwin-x86_64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/taniwhaai/arai/releases/download/v#{version}/arai-linux-aarch64"
      sha256 "855a7cd187d6d3d96d85298eafd441b68c85d1d568dfb22b2504f33d2672c6de"
    end
    on_intel do
      url "https://github.com/taniwhaai/arai/releases/download/v#{version}/arai-linux-x86_64"
